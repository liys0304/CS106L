...
int mag(const vector<int> &vec) { return std::sqrt(dotProduct(vec, vec)); }
...
int countOccurences(const string &word, const string &text) { //"the" vs."there"
  string toFind = " " + word + " ";
  // std::search
...
int main() {
  // prepare the text of the files for processing
  ...
  cout << "Similarity - madison <-> unknown:   " << getSimilarity(f_mad, f_unk)
       << endl;
  cout << "Similarity - jj <-> unknown:   " << getSimilarity(f_jj, f_unk)
       << endl;
  cout << "Similarity - hamilton <-> unknown:   " << getSimilarity(f_ham, f_unk)
       << endl;
